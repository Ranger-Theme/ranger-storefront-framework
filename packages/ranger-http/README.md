...
- [Npm](https://www.npmjs.com/package/@ranger-theme/http)
- [CHANGELOG](CHANGELOG.md)

## 📦 Install

```bash
$ npm install --save-dev @ranger-theme/http
# or
$ yarn add --save-dev @ranger-theme/http
# or
$ pnpm add --save-dev @ranger-theme/http
```
...
- TypeScript support
- 2 dependencies ([use-ssr](https://github.com/alex-cory/use-ssr))
...
- useFetch - suspense <sup>(experimental)</sup>
- useFetch - pagination
- useQuery - GraphQL
- useFetch - Next.js
...
| `suspense` | Enables Experimental React Suspense mode. | `false` |
